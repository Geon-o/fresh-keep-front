        ...
        <View style={[styles.card, { backgroundColor: cardColor, borderColor }]}>
          ...
          <Text style={[styles.bodyText, { color: descColor }]}>
            {"1. '서비스'라 함은 제공자가 개발하여 제공하는 식재료 유통기한 관리, 냉장고 관리 및 연동 서비스 전체를 의미합니다.\n" +
             ...
             "3. '백업 키'라 함은 이용자의 식재료 및 냉장고 데이터를 서버와 동기화하고 차후 기기 변경 시 복구하기 위해 서비스 내에서 임의로 생성하여 제공하는 고유 식별 키를 의미합니다."}
          </Text>
          ...
          <Text style={[styles.sectionTitle, { color: titleColor }]}>제4조 (데이터 백업 및 백업 키의 관리 책임)</Text>
          <Text style={[styles.bodyText, { color: descColor }]}>
            {"1. 본 서비스는 회원가입 정보가 없으므로 이용자의 냉장고 데이터를 식별할 유일한 수단으로 '백업 키'를 제공합니다.\n" +
             "2. 이용자는 본인의 백업 키를 안전한 장소에 기록·오프라인 보관해야 하며, 이를 타인에게 공개하거나 분실해서는 안 됩니다.\n" +
             "3. 백업 키는 일방향 해시 및 암호화 처리가 적용되어 데이터베이스에 보관되므로, 서비스 제공자는 이용자의 분실된 백업 키를 역추적하거나 찾아줄 수 없습니다.\n" +
             "4. 이용자의 관리 소홀로 인한 백업 키 분실, 유출 및 이로 인한 데이터 유실에 대한 모든 책임은 이용자 본인에게 있습니다."}
          </Text>
          ...
          <Text style={[styles.bodyText, { color: descColor }]}>
            {"본 서비스는 이용자의 개인정보를 일절 수집 및 보유하지 않으며, 전적으로 비인식 단말 식별값 및 데이터 동기화를 위한 익명 백업 키만을 사용합니다."}
          </Text>
          ...
          <Text style={[styles.bodyText, { color: descColor }]}>
            {"1. 서비스 제공자는 천재지변, 서버 점검, 네트워크 마비 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.\n" +
             "2. 이용자의 기기 고장, 초기화, 백업 키 유실로 인해 발생한 데이터 유실 손해에 대해 서비스 제공자는 책임을 지지 않습니다."}
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
